...
public class TwitterTest extends WithApplication {
	...
	// play.mvc.Http.RequestBuilder mockActionRequest =
	//// Helpers.fakeRequest(controllers.routes.Twitter.homeTimeline());
	// Result result = Helpers.route(testApp, mockActionRequest);
	// assertThat(result.status(),
	//// CoreMatchers.is(CoreMatchers.equalTo(SEE_OTHER)));
	// });
	// }
